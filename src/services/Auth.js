...
export default class Auth {
    constructor() {
        this.BASE_URL = process.env.GRIDSOME_BASE_URL
        this.redirectURI = process.env.GRIDSOME_OAUTH_CALLBACK
        this.clientId = process.env.GRIDSOME_OAUTH_CLIENT_ID
        this.clientSecret = process.env.GRIDSOME_OAUTH_CLIENT_SECRET
    }
